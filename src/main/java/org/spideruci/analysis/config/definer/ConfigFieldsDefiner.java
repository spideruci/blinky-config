...
public class ConfigFieldsDefiner extends PrototypicalClassAdapter {
  ...
  private static void checkConfig(
    ...
    for(String configableFieldName : config.keySet()) {
      ...
      LOG.debug("Public, static field %s present in %s", configableFieldName, className);
      
      if(configClassScanner.publicStaticFieldIsDefined(configableFieldName)) {
        LOG.debug("Public, static field %s already defined in %s", configableFieldName, className);
        continue;
      }
      
      LOG.debug("Public, static field %s not yet defined in %s", configableFieldName, className);
